...
// import React, { useState } from 'react';
// import { View, Text, StyleSheet, Image, TextInput, TouchableOpacity, ScrollView, Modal,Alert, StatusBar } from 'react-native';
// // import Mybutton from "@/components/Mybutton";
// import {useRouter } from 'expo-router';
...
//   const API_URL = 'http://192.168.52.190:9000/api/auth/login';

//   const onLogin = async () => {
//     try {
//       console.log('Sending data:', { emailOrPhone, password });
...
//         router.navigate('/verification'); // Ensure router is properly configured
//       }
//        else {
...
//         errorMessage = err.response?.data?.message || 'Network or server error occurred';
//       } else if (err instanceof Error) {
//         errorMessage = err.message;
//       }

//       Alert.alert('Error', errorMessage);
//       setError(errorMessage); // Optional: depends on how you use setError
//     }
//   };
...
//     try {
//       const response = await axios.post('http://192.168.52.190:9000/api/auth/', { emailOrPhone });
