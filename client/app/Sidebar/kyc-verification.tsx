...
const KYCVerification = () => {
  ...
  const handleVerification = async () => {
    ...
    // Simulating API call to send data for verification
    setTimeout(() => {
      setIsSubmitting(false);
      Alert.alert(
        'Verification Submitted',
        'Your KYC verification request has been sent. Status will be updated after verification.'
      );
    }, 2000);

    router.push('/Sidebar/kycverification'); // Redirect user after submission
  };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.statusContainer}>
          <Text style={[styles.kycStatus, kycStatus === 'Verified' ? styles.verified : styles.notVerified]}>
            {kycStatus}
          </Text>
        </View>
...
const styles = StyleSheet.create({
  container: { flexGrow: 1, backgroundColor: '#ADD8E6' },
  backButton: { marginRight: 10, padding: 10 },
  header: { flexDirection: 'row', alignItems: 'center', paddingVertical: 16, backgroundColor: '#ADD8E6', paddingHorizontal: 16, marginBottom: 10 },
  headerTitle: { fontSize: 25, color: 'black', fontWeight: 'bold' },
  card: { backgroundColor: '#E6F2FA', padding: 20, margin: 20, borderRadius: 8, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
  label: { fontSize: 16, fontWeight: 'bold', color: '#555', marginBottom: 8 },
  input: { borderWidth: 1, borderColor: '#ccc', borderRadius: 8, padding: 8, marginBottom: 16, fontSize: 14 },
  uploadButton: { backgroundColor: 'black', paddingVertical: 10, borderRadius: 8, alignItems: 'center', marginBottom: 10 },
  uploadButtonText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
  uploadedImage: { width: 150, height: 150, resizeMode: 'contain', marginBottom: 16 },
  submitButton: { backgroundColor: 'black', paddingVertical: 12, borderRadius: 8, alignItems: 'center' },
  submitButtonText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
  statusContainer: { marginBottom: 16, padding: 10, backgroundColor: '#fff', borderRadius: 8 },
  kycStatus: { fontSize: 16, fontWeight: 'bold', textAlign: 'center' },
